...
geojsonPath = Path.cwd()/'data/limitespdq.geojson' # You might need to change this depending on where and how you are running this code
...
criminalLogsPath = Path.cwd()/'data/actes-criminels.csv'
...
fig = px.choropleth_mapbox(df, geojson=geojson, 
                           color = "PDQ", # Might need to change depending on what you want to measure
